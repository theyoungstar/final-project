...
namespace Catalyte.Apparel.Data.Model
{
    ...
    public class CardValidation
    {
        ...
        {   
            ...
            if (!cardCheck.IsMatch(field.Trim()) && field.Length > 0) // checks card number has between 14-19 numbers
            {
        ...
        public string IsEmptyExpirationDate(string field, List<string> errorsList)
        {
            if (field == "")
            {
